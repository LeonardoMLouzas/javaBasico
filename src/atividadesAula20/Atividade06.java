...
//Fa�a um programa para jogar o jogo da velha. O programa deve permitir que dois jogadores fa�am uma partida do jogo da velha, usando o computador para ver o tabuleiro. Cada jogador vai alternadamente informando a posi��o onde deseja colocar a sua pe�a ("O" ou "X"). O programa deve impedir jogadas inv�lidas e determinar automaticamente quando o jogo terminou e quem foi o vencedor (jogador1 ou jogador2). A cada nova jogada, o programa deve atualizar a situa��o do tabuleiro na tela.
